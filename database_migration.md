...
```bash
# Alembic will inspect your models and generate migration
...
Done! 🚀 You now have SQL Server running in Docker with proper database migrations for local FastAPI development.
